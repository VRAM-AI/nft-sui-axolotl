...
fun new(image_blob_id : String, description : String, ctx: &mut TxContext): VramNFT {
...
public entry fun update_price(treasury: &mut Treasury, price: u64, ctx: &mut TxContext) {
